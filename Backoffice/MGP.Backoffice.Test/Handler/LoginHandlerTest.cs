...
namespace MGP.Backoffice.Test.Handler
{
    public class LoginHandlerTest
    {
        ...
        public async Task Handle_ShouldReturnBadRequest_WhenParametersAreMissing()
        {
            ...
            {
                Errors = { new FluentValidation.Results.ValidationFailure("Password", _messageManager.GetNotification(FunctionalErrors.NOT_NULL, nameof(LoginRequest.Password))) }
            };
        ...
        public async Task Handle_ShouldReturnLocked_WhenUserDisable()
        {
            ...
            //Assert
            Assert.Equal((int)Code.Locked, result.Code);
