...
public class GetTicketCudAgentHandler : IRequestHandler<GetTicketCudAgentRequest, ResponseData<GetTicketCudData, ResponseMessage>>
{
    private readonly ITicketService _TicketService;
    private readonly IValidator<GetTicketCudAgentRequest> _validator;
    private readonly MessageManager _messageManager;

    public GetTicketCudAgentHandler(ITicketService TicketService,
                            IValidator<GetTicketCudAgentRequest> validator,
    ...
    public async Task<ResponseData<GetTicketCudData, ResponseMessage>> Handle(GetTicketCudAgentRequest request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            GetTicketCudData getTicketResponse = await _TicketService.GetTicketCudAgentAsync(request.TicketId, request.TicketCode);
