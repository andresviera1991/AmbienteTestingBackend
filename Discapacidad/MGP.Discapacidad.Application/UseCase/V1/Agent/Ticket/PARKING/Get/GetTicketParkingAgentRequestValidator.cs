...
public class GetTicketParkingAgentRequestValidator : AbstractValidator<GetTicketParkingAgentRequest>
{
    private readonly MessageManager _messageManager;

    public GetTicketParkingAgentRequestValidator(MessageManager messageManager)
    {
