...
public class GetTicketUserHandler : IRequestHandler<GetTicketUserRequest, ResponseData<object, ResponseMessage>>
{
    private readonly IValidator<GetTicketUserRequest> _validator;
    private readonly ITicketService _ticketService;
    private readonly MessageManager _messageManager;

    public GetTicketUserHandler(ITicketService ticketService,
                                MessageManager messageManager,
                                IValidator<GetTicketUserRequest> validator)
    {
    ...
    public async Task<ResponseData<object, ResponseMessage>> Handle(GetTicketUserRequest request, CancellationToken cancellationToken)
    {
        try
        {
            ...
            object response = await _ticketService.GetTicketUserAsync(request.ServiceName, request.TicketTypeId, request.TicketId, request.UserId);
